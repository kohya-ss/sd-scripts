...
class DreamBoothDataset(BaseDataset):
    ...
    def __init__(self, batch_size, root_train_data_dir, reg_data_dir, tokenizer, max_token_length, caption_extension, shuffle_caption, shuffle_keep_tokens, resolution, enable_bucket, min_bucket_reso, max_bucket_reso, bucket_reso_steps, bucket_no_upscale, prior_loss_weight, flip_aug, color_aug, face_crop_aug_range, random_crop, debug_dataset) -> None:
        ...
        if isinstance(root_train_data_dir, str):
            ...
            if not root_train_data_dir.resolve().exists():
                raise KohyaDatasetException(
                    ...
                    "root_train_data_dir フォルダーが存在しません。" # TODO: Kohya, if possible, please translate this back to Japanese. Thanks!
                )
