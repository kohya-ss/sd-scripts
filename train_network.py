...
def generate_step_logs(
    ...
    if args.network_train_text_encoder_only or len(lrs) <= 2:  # not block lr (or single block)
        ...
        if args.optimizer_type.lower().startswith("DAdapt".lower()) or args.optimizer_type.lower() == "Prodigy":  # tracking d*lr value of unet.
        ...
        for i in range(idx, len(lrs)):
            ...
            if args.optimizer_type.lower().startswith("DAdapt".lower()) or args.optimizer_type.lower() == "Prodigy":
