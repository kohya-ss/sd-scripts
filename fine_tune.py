...
from library.dataset import FineTuningDataset
...
def train(args):
    ...
    train_dataset = FineTuningDataset(args.in_json, args.train_batch_size, args.train_data_dir,
                                      tokenizer, args.max_token_length, args.shuffle_caption,
                                      args.keep_tokens,
                                      args.resolution, args.enable_bucket, args.min_bucket_reso,
    ...
    for epoch in range(num_train_epochs):
        ...
        if args.save_every_n_epochs is not None:
            ...
            train_util.save_sd_model_on_epoch_end(args, accelerator, src_path, save_stable_diffusion_format,
                                                  use_safetensors,
                                                  save_dtype, epoch, num_train_epochs, global_step,
                                                  unwrap_model(text_encoder), unwrap_model(unet), vae)
