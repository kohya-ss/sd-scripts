...
def train(args):
    ...
    accelerator_setup.prepare_dataset_args(args, False)
    ...
    # モデルを読み込む
    text_encoder, vae, unet, load_stable_diffusion_format = model_io.load_target_model(args, weight_dtype, accelerator)
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    args_util.add_dataset_arguments(parser, True, False, True)
