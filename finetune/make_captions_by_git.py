...
def main(args):
    ...
    org_prepare_input_ids_for_generation = (
        GenerationMixin._prepare_input_ids_for_generation
    )
    ...
    def _prepare_input_ids_for_generation_patch(self, bos_token_id, encoder_outputs):
        input_ids = org_prepare_input_ids_for_generation(
            self, bos_token_id, encoder_outputs
        )
    ...
    GenerationMixin._prepare_input_ids_for_generation = (
        _prepare_input_ids_for_generation_patch
    )
